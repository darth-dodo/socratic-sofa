...
Learn how to create effective custom philosophical topics for Socratic Sofa that generate rich, insightful dialogues.

## Overview

While the topic library provides 100 curated questions, the real power of Socratic Sofa lies in exploring your own philosophical inquiries. This guide teaches you how to craft topics that work effectively with the Socratic method.

## Understanding Effective Topics

### What Makes a Good Socratic Topic?

**Core Principles:**

1. **Open-Ended**: No single correct answer
2. **Depth**: Multiple layers to explore
3. **Assumption-Rich**: Contains beliefs to examine
4. **Debatable**: Reasonable people can disagree
5. **Universal**: Relevant beyond specific contexts
...
### The Socratic Method Requirements
...
Good concepts:
- Abstract nouns (freedom, truth, love)
- Philosophical terms (virtue, wisdom, essence)
- Contested ideas (intelligence, creativity, success)

Avoid:
- Concrete objects (chair, car, phone)
- Technical terms with standard definitions
- Proper nouns (who is..., where is...)
```
...
Strong actions:
- Ethically complex (lie, restrict, enhance)
- Value-laden (prioritize, protect, sacrifice)
- Socially significant (regulate, permit, forbid)

Avoid:
- Purely personal preferences
- Obviously yes/no answers
- Factual predictions
```
...
- Philosophical (know, understand, prove)
- Metaphysical (exist, occur, persist)
- Ethical (justify, obligate, permit)

Avoid:
- Technical abilities (build, compute, measure)
- Future predictions (will happen)
- Physical constraints (physics laws)
```
...
Strong contrasts:
- Philosophical dichotomies (real/illusory, objective/subjective)
- Metaphysical options (material/immaterial, natural/supernatural)
- Ethical frameworks (absolute/relative, universal/particular)

Avoid:
- Factual questions (is water H2O?)
- Obvious answers (is murder wrong?)
- False dichotomies (forced binary without middle ground)
```
...
Formula: Should/Can/Is [tech concept] [philosophical question]?

Examples:
- "Should AI systems explain their decisions?"
- "Can digital art be authentic?"
...
Formula: Should/Do/Is [environmental concern] [ethical framework]?

Examples:
- "Should we prioritize human needs over biodiversity?"
- "Is climate change a justice issue?"
- "Do ecosystems have moral standing?"
```
...
- Should we prioritize family or community?
...
Formula: Should/Can/What is [life domain] [philosophical dimension]?

Examples:
- "Should we pursue passion or stability in careers?"
- "Can relationships be purely rational?"
- "Is authenticity more important than kindness?"
```
...
Before running your topic through Socratic Sofa, evaluate it:
...
20-25: Excellent topic, proceed
15-19: Good topic, minor refinement
10-14: Needs significant improvement
0-9:   Reconsider or major revision
```
...
Fix: "What makes an action morally good?"
```
...
Problem: "Did Kant believe in free will?"
Fix: "Is free will compatible with moral responsibility?"
```
...
Problem: "Is qualia reducible to physical states?"
Fix: "Can science fully explain consciousness?"
```
...
Problem: "How do I become successful?"
Fix: "What is success?"
```
...
Problem: "Am I a good person?"
Fix: "What makes someone a good person?"
```
...
- Can you change the past without creating a paradox?
...
Examples:
- If you could live forever, would life still have meaning?
- If you could read minds, would privacy matter?
- If perfect happiness required ignorance, would you choose it?
```
...
**Technique: Intersectional Topics**
...
Examples:
- Is the concept of self universal?
- Are moral values culturally relative?
- Is beauty standards universal?
```
...
Examples:
- Has human nature changed with technology?
- Is modern ethics different from ancient ethics?
...
**Version 3 (Depth):**
"Does technology fundamentally change what it means to be human?"

**Version 4 (Assumptions):**
"Should we accept technology's transformation of human nature?"
...
- V4: Adds normative dimension
- V5: Precise, philosophical, assumption-rich
...
- Is there a philosophical method?
...
Examples:
- If determinism is true, is morality an illusion?
- If God exists, is morality objective?
- If consciousness is computation, can machines be conscious?
```
...
✅ Has historical philosophical discussion
...
- Contemporary conflicts (principle-focused)
...
"What are the ethical limits of [controversial practice]?"
```
...
Best:    "Do our tools shape our consciousness?"
```
...
Best:    "What are the limits of moral obligation?"
```
...
Best:    "Can empirical observation lead to certain knowledge?"
```
...
Best:    "Can political authority be justified?"
```
...
Best:    "Is consciousness reducible to brain processes?"
```
...
4. Is moral luck problematic?
5. Do circumstances excuse actions?
...
4. Expert: "Is the concept of justice coherent?"

## Resources for Inspiration

### Classical Sources

- Plato's Dialogues (especially early Socratic dialogues)
- Aristotle's Questions in Metaphysics and Ethics
- Descartes' Meditations (methodological doubt)
- Kant's Critical Questions
- Mill's On Liberty (freedom questions)

### Contemporary Philosophy

- Thought experiments from philosophy papers
- Contemporary ethics case studies
- Philosophy podcasts (Philosophy Bites, etc.)
- Stanford Encyclopedia of Philosophy
- PhilPapers research database

### Interdisciplinary Connections

- Psychology: consciousness, decision-making, identity
- Physics: time, causation, reality
- Biology: life, evolution, nature
- Computer Science: computation, AI, information
- Law: rights, justice, punishment
- Economics: value, choice, distribution

## Conclusion

Creating effective custom topics is both art and science. It requires philosophical understanding, careful formulation, and iterative refinement. The best topics arise from genuine curiosity, are crafted with care, and refined through testing.

Start simple, learn from results, and gradually develop your ability to formulate profound philosophical questions. The Socratic Sofa system is designed to explore your inquiries - the quality of exploration depends on the quality of questions you ask.
...
- Learn from generated dialogues
